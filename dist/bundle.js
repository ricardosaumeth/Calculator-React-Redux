...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_PropTypes__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapStateToProps__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mergeProps__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__selectorFactory__ = __webpack_require__(35);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wrapMapToProps__ = __webpack_require__(8);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(36);
...
const redux_1 = __webpack_require__(5);
const react_redux_1 = __webpack_require__(15);
const logger = __webpack_require__(16);
const reducers_1 = __webpack_require__(49);
const Layout_1 = __webpack_require__(50);
...
Object.defineProperty(exports, "__esModule", { value: true });
const redux_1 = __webpack_require__(5);
const reducer_operations_1 = __webpack_require__(54);
const allReducers = redux_1.combineReducers({
    value: reducer_operations_1.default
});
...
const redux_1 = __webpack_require__(5);
const react_redux_1 = __webpack_require__(15);
const Screen_1 = __webpack_require__(51);
const Keys_1 = __webpack_require__(52);
...
exports.IdentifyDigit = IdentifyDigit;
...
function default_1(state = initialState, action) {
    switch (action.type) {
        case 'OPERATOR':
            state = Object.assign({}, state, { result: action.payload, lastValue: [...state.lastValue, action.payload] });
            break;
    }
    return state;
}
